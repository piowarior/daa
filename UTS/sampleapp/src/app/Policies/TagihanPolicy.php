...
class TagihanPolicy
{
    ...
    {
        return $user->can('view_any_tagihan');
    }
    ...
    {
        return $user->can('create_tagihan');
    }
    ...
    {
        return $user->can('update_tagihan');
    }
    ...
    {
        return $user->can('delete_tagihan');
    }
    ...
    {
        return $user->can('delete_any_tagihan');
    }
     ...
     */
    public function replicate(User $user, Tagihan $tagihan): bool
    {
